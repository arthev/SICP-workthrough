...
;2.70
(define rock-tree (generate-huffman-tree (list (list 'A 2) (list 'GET 2) (list 'SHA 3) (list 'WAH 1) 
...
;The encoding takes 84 bits.
;For a fixed length code we would need 3 bits per symbol of the alphabet.
;The message is 36 symbols long. 36*3=108.
;So we save 24 bits by using a variable length encoding.
