...
(define (install-polynomial-package)
  ...
  (define (div-poly p1 p2)
	(if (same-variable? (variable p1) (variable p2))
	  (let ((results (div-terms (term-list p1) (term-list p2))))
	  ...
	  (let ((t1 (first-term L1))
		...
		(if (> (order t2) (order t1))
		  ...
		  (let ((new-c (div (coeff t1) (coeff t2)))
			...
			(let ((rest-of-result (div-terms (sub-poly L1 
													   (mul-terms-by-all-terms 
														 (make-term new-o new-c) 
														 L2)) 
											 L2)))
			  (list (adjoin-term (make-term new-o new-c) (car rest-of-results))
					(cadr rest-of-results))))))))
  (define (negate-poly p)
	(make-poly (variable p)
			   (map (lambda (t) (make-term (order t) (negate (coeff t)))) 
					(term-list p))))
  (define (sub-pol p1 p2)
	(if (same-variable? (variable p1) (variable p2))
	  (make-poly (variable p1)
