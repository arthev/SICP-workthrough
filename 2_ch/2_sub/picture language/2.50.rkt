...
(define right-split (split beside below)) ;lol, had to drag these down because of definition ordering
(define up-split (split below beside)) ;lol, definition ordering, hehe.

(paint (beside einstein (flip-horiz einstein)))
(paint (below einstein (flip-horiz einstein)))
